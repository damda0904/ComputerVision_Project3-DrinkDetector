...
def load_model(model_name):
  ...
  model_dir = 'C:/deeplearning_test/models/research/object_detection/local_models/'+model_name  # efficientdet_d1
...
PATH_TO_LABELS = 'C:/deeplearning_test/models/research/object_detection/data/drinks_label_map.pbtxt'
...
#--- Detection --#
model_name =  'trained_model_large_original_20000'#'centernet_resnet50_v1_fpn_512x512_kpts_coco17_tpu-8' #'efficientdet_d0_coco17_tpu-32' #'ssd_mobilenet_v1_coco_2017_11_17'
...
def run_inference(model, cap):
    ...
    while cap.isOpened():
        ...
        image_np, ex_label_first = vis_util.visualize_boxes_and_labels_on_image_array(
            image_np,
            output_dict['detection_boxes'],
            output_dict['detection_classes'],
            output_dict['detection_scores'],
