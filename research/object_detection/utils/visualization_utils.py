...
def draw_bounding_box_on_image(image,
  ...
  for display_str in display_str_list[::-1]:
    ...
    if("cider" in display_str):
        if(ex_label != 'cider'):
            pygame.mixer.music.load("cider.mp3")
    ...
    elif("Demisoda" in display_str):
        if(ex_label != 'Demisoda'):
            pygame.mixer.music.load("Demisoda.mp3")
            pygame.mixer.music.play()
            clock = pygame.time.Clock()
            while pygame.mixer.music.get_busy():
                clock.tick(30)
    ...
    elif("coke" in display_str):
        if(ex_label != 'coke'):
            pygame.mixer.music.load("coke.mp3")
            pygame.mixer.music.play()
            clock = pygame.time.Clock()
            while pygame.mixer.music.get_busy():
                clock.tick(30)
    ...
    elif('Tejava' in display_str):
        if(ex_label != 'Tejava'):
            pygame.mixer.music.load("Tejava.mp3")
            pygame.mixer.music.play()
            clock = pygame.time.Clock()
            while pygame.mixer.music.get_busy():
                clock.tick(30)
